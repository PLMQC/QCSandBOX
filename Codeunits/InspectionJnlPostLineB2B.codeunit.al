        ...
        if QualityItemLedgEntry.FIND('-') then
            repeat
                ...
                if QualityLedgEntry3."Vendor No." = PurchHeader."Buy-from Vendor No." then begin
                    ...
                    if (QualityItemLedgEntry."Lot No." = '') and (QualityItemLedgEntry."Serial No." = '') then //B2BQC1.00.01
                        PurchLine.VALIDATE("Appl.-to Item Entry", QualityItemLedgEntry."Entry No.");
                    PurchLine.INSERT(true);
                    if (QualityItemLedgEntry."Lot No." <> '') or (QualityItemLedgEntry."Serial No." <> '') then //B2BQC1.00.01
                        UpdateResEntryFortReturnOrder(PurchLine, QualityItemLedgEntry);//B2BQC1.00.01
                end;
            until QualityItemLedgEntry.NEXT() = 0;
        //end;
    end;
