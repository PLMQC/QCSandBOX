Codeunit 33000261 "ItemJnlPostLineExt B2B"
{
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Item Jnl.-Post Line", 'OnPostSplitJnlLineOnBeforeSplitJnlLine', '', false, false)]
    local procedure ItemPostQc(var PostItemJournalLine: Boolean; var ItemJournalLine: Record "Item Journal Line")
    begin

        IF ItemJournalLine."Quality Ledger Entry No. B2B" <> 0 THEN
