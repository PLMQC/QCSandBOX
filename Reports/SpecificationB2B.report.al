report 33000253 "Specification B2B"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layouts\Specification.rdlc';
    ...
    dataset
    {
        dataitem("Specification Header"; "Specification Header B2B")
        {
            ...
            dataitem("Specification Line"; "Specification Line B2B")
            {
