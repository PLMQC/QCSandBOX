    ...
    fields
    {
        ...
        field(6500; "Serial No."; Code[20])
        {
            ...
            begin
                ...
                //ItemTrackingMgt.LookupLotSerialNoInfo("Item No.", "Variant Code", ItemTrackEnum::"Serial No.", "Serial No.");
            end;
        }
        field(6501; "Lot No."; Code[20])
        {
            ...
            begin
                ...
                // ItemTrackingMgt.LookupLotSerialNoInfo("Item No.", "Variant Code", ItemTrackEnum::"Lot No.", "Lot No.");
            end;
        }
